...
dico = {
    "a": 0, "b": 1, "c": 2, "d": 3, "e": 4, "f": 5, "g": 6, "h": 7, "i": 8, "j": 9, "k": 10,
        ...
        "v": 21, "w": 22, "x": 23, "y": 24, "z": 25, "aa": 26, "ab": 27, "ac": 28
}
...
header_installations_uniques_csv_v2_2 = [
  (csv_en_liste_v2(data_csv, 0, codeInstallation)), (csv_en_liste_v2(data_csv, 0, nomInstallation)),
  (csv_en_liste_v2(data_csv, 0, nbEquipements)), (csv_en_liste_v2(data_csv, 0, adresse)),
  (csv_en_liste_v2(data_csv, 0, nbParking)), (csv_en_liste_v2(data_csv, 0, nbParkingHandi))
]
data_installations_uniques_csv_v2_2 = [
  (csv_en_liste_v2(data_csv, 1, codeInstallation)), (csv_en_liste_v2(data_csv, 1, nomInstallation)),
  (csv_en_liste_v2(data_csv, 1, nbEquipements)), (csv_en_liste_v2(data_csv, 1, adresse)),
  (csv_en_liste_v2(data_csv, 1, nbParking)), (csv_en_liste_v2(data_csv, 1, nbParkingHandi))
]

ecriture_csv(data_installations_uniques_csv, header_installations_uniques_csv_v2_2, data_installations_uniques_csv_v2_2)
...
#data_installations_uniques_csv_v2 = [(csv_en_liste_v2(data_csv, 1, 2)), (csv_en_liste_v2(data_csv, 1, 3)),  (csv_en_liste_v2(data_csv, 1, 0)), (csv_en_liste_v2(data_csv, 1, 1))]

header_communes_uniques_csv_v2_2 = [
  (csv_en_liste_v2(data_csv, 0, codeInseeCommune)), (csv_en_liste_v2(data_csv, 0, nomCommune)),
  (csv_en_liste_v2(data_csv, 0, codeDepartement)), (csv_en_liste_v2(data_csv, 0, nomDepartement))
]
data_communes_uniques_csv_v2_2 = [
  (csv_en_liste_v2(data_csv, 1, codeInseeCommune)), (csv_en_liste_v2(data_csv, 1, nomCommune)),
  (csv_en_liste_v2(data_csv, 1, codeDepartement)), (csv_en_liste_v2(data_csv, 1, nomDepartement))
]
ecriture_csv(data_communes_uniques_csv, header_communes_uniques_csv_v2_2, data_communes_uniques_csv_v2_2)
...
header_admissions_par_formation_detaillee_csv_v2_2 = [
    (csv_en_liste_v2(data_csv, 0, codeInstallation)), (csv_en_liste_v2(data_csv, 0, codeInseeCommune)),
    (csv_en_liste_v2(data_csv, 0, libelle)), (csv_en_liste_v2(data_csv, 0, metro)),
    (csv_en_liste_v2(data_csv, 0, bus)), (csv_en_liste_v2(data_csv, 0, tram)),
    (csv_en_liste_v2(data_csv, 0, train)), (csv_en_liste_v2(data_csv, 0, bateau)),
    (csv_en_liste_v2(data_csv, 0, autreTransport)), (csv_en_liste_v2(data_csv, 0, aucunTransport)),
    (csv_en_liste_v2(data_csv, 0, dateMAJ)), (csv_en_liste_v2(data_csv, 0, dateCreation))
]
data_admissions_par_formation_detaillee_csv_v2_2 = [
    (csv_en_liste_v2(data_csv, 1, codeInstallation)), (csv_en_liste_v2(data_csv, 1, codeInseeCommune)),
    (csv_en_liste_v2(data_csv, 1, libelle)), (csv_en_liste_v2(data_csv, 1, metro)),
    (csv_en_liste_v2(data_csv, 1, bus)), (csv_en_liste_v2(data_csv, 1, tram)),
    (csv_en_liste_v2(data_csv, 1, train)), (csv_en_liste_v2(data_csv, 1, bateau)),
    (csv_en_liste_v2(data_csv, 1, autreTransport)), (csv_en_liste_v2(data_csv, 1, aucunTransport)),
    (csv_en_liste_v2(data_csv, 1, dateMAJ)), (csv_en_liste_v2(data_csv, 1, dateCreation))
]

ecriture_csv(data_admissions_par_formation_detaillee_csv, header_admissions_par_formation_detaillee_csv_v2_2, data_admissions_par_formation_detaillee_csv_v2_2)
